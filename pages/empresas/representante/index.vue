                  ...
                  <tbody>
                    <tr v-for="(m, i) in list">
                      ...
                      <td data-label="Acciones" class="py-0 px-1">
                        <div class="btn-group">
                          <button type="button" @click="dessii(m), abrirEditar(m)"
          ...
          <div class="modal fade" :class="modalIngreso ? 'showModal' : ''" id="AjusteModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="form-group col-md-6">
                  <label for="">Clave SII</label>
                  <input type="password" name="" v-model="c_sii" class="form-control" id="" />
                </div>
                <div class="form-group col-md-6">
                  <label for="">Clave Unica</label>
                  <input type="text" name="" v-model="c_unica" class="form-control" id="" />
                </div>
          ...
          <div class="modal fade" :class="modalEditar ? 'showModal' : ''" id="AjusteModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="form-group col-md-6">
                  <label for="">Clave SII</label>
                  <input type="text" name="" v-model="c_sii" class="form-control" id="" />
                </div>
                <div class="form-group col-md-1">
                  <label for="">...</label>
                  <button type="button" @click="toggleShowPassword" class="btn btn-danger btn-sm py-1 px-2">
                            <i class="fas fa-trash"></i>
                          </button>
                </div>
                <div class="form-group col-md-5">
                  <label for="">Desencritada</label>
                ...
                <div class="modal-footer">
                  <button type="button" @click="modalEditar = false, encryptPassword(), Update()" class="btn bg-gradient-secondary w-100"
                    data-bs-dismiss="modal">
                    Actualizar
                  </button>
                </div>
 ...
 return parseInt(value).toLocaleString("de-DE")
  ...
  methods: {
    ...
    encryptPassword() {
        ...
        this.encryptedPassword = CryptoJS.AES.encrypt(this.c_sii, 'your-secret-key').toString();
    ...
    toggleShowPassword() {
      ...
      if (this.showPassword) {
        ...
        const encryptedPassword = this.c_sii;
        if (encryptedPassword) {
          const bytes = CryptoJS.AES.decrypt(encryptedPassword, 'your-secret-key');
          this.c_sii = bytes.toString(CryptoJS.enc.Utf8);
        } else {
          this.c_sii = 'No hay contraseña guardada';
        }
      } else {
        this.c_sii = '';
      }
